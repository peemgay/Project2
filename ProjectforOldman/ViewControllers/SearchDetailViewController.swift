...
class SearchDetailViewController: UIViewController {
    @IBOutlet var backViewDetail: UIImageView!
    @IBOutlet var nameSearchDetail: UILabel!
    @IBOutlet var priceSearchDetail: UILabel!
    @IBOutlet var locationSearchDetail: UILabel!
   ...
   @IBOutlet weak var inputTextField: UITextField!
        ...
        @IBAction func onClickOK(_ sender: Any) {
            ...
            ผู้ใหญ่ \(label2.text!)
            เด็ก \(label3.text!)
            รวมยอดทั้งสิ้น \(priceSearchDetail.text!)
            """
            ...
            let okAction = UIAlertAction(title: "Book", style: UIAlertAction.Style.default) {
                    UIAlertAction in
                self.performSegue(withIdentifier: "Explor", sender: nil)
               print("show home")
            }
        ...
        override func viewDidLoad() {
            ...
            nameSearchDetail.text = "\(name)"
            backViewDetail.image = image
            priceSearchDetail.text = "\(price)"
            locationSearchDetail.text = "\(location)"
